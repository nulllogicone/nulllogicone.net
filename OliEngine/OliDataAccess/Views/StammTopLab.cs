...
namespace OliEngine.OliDataAccess.Views
{
    ...
    ///     StammTopLab.
    /// </summary>
    public class StammTopLab : StammTopLabDataSet
    {
        public StammTopLab()
        {
            ...
            cmd.CommandText = "oli.Get_StammTopLab";
            cmd.Connection = con;
        ...
        public StammTopLab(StammDataSet.StammRow stammRow)
        {
            SqlConnection con = OliCommon.OLIsConnection;

            SqlCommand cmd = new SqlCommand();
            cmd.CommandType = CommandType.StoredProcedure;
            cmd.CommandText = "oli.Get_StammTopLab_StammGuid";
