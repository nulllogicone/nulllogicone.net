...
namespace OliEngine.OliDataAccess
{
    ...
    public class PostIt : PostItDataSet
    {
        ...
        ///     ge�ndert werden.
        ///     Das Hinzuf�gen eines neuen PostIt wird �ber den DataAdapter erledigt
        /// </summary>
        /// <returns></returns>
        ...
        /// <summary>
        ///     die Verkn�pfungstabelle zwischen Stamm und PostIt aktualisieren
        /// </summary>
        /// <returns></returns>
