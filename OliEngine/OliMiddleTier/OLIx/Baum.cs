...
namespace OliEngine.OliMiddleTier.OLIx
{
    ...
    ///     Ein Baum besteht aus Zweigen, die Alternativen darstellen und zu Netzen oder B�umen weiterverzweigen.
    ///     Ein Baum kann mehrfach verlinkt werden.
    ///     Die Defaultmarkierung wird aus dem verlinkenden Knoten �bernommen.
    /// </summary>
    public class Baum : BaumDataSet
    {
        ...
        public List<List<HyperLink>> PathToRoot()
        {
            ...
            {
                // gib den rekursiven Pfad zur�ck
