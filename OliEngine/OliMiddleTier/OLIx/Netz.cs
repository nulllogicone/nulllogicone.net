...
namespace OliEngine.OliMiddleTier.OLIx
{
    ...
    ///     Es enth�lt Knoten, die markiert werden k�nnen (mit default Werten), 
    ///     und von denen weitere Netze bzw. B�ume verlinkt sind.
    /// </summary>
    public class Netz : NetzDataSet
    {
        ...
        /// <summary>
        ///     erstellt ein neues Netz und l�dt alle Datens�tze
        /// </summary>
        public Netz()
        {
