...
namespace OliWeb.Controls.Wortraum
{
    ...
    ///    Zweig.
    ///</summary>
    public partial class ZweigControl : System.Web.UI.UserControl // VerteilControl
    {
        protected System.Web.UI.WebControls.Image EbeneImage2;
        protected System.Web.UI.WebControls.Panel ShowPanel;
...
//1		NKBZ nkbz;
        ...
        protected OliWeb.Controls.Wortraum.BuntePunkte BuntePunkteMark;
...
//		private NKBZDataSet.ZweigRow myRow
        ...
        public OliWeb.Controls.Wortraum.BuntePunkte BuntePunkte
        {
...
//1			nkbz = NKBZ.Instance();
        ...
        protected void WeiterNetzImageButton_Click(object sender, System.Web.UI.ImageClickEventArgs e)
        {
            ZweigLinkButton_Click(sender, e);
        }

        // WeiterBaumImageButton_Click
        protected void WeiterBaumImageButton_Click(object sender, System.Web.UI.ImageClickEventArgs e)
        {
            ZweigLinkButton_Click(sender, e);
        }

        // WeiterNixImageButton_Click
        protected void weiterNixImageButton_Click(object sender, System.Web.UI.ImageClickEventArgs e)
        {
            ZweigLinkButton_Click(sender, e);
        }
...
//1			nkbz.UpdateZweig();
        ...
        protected void EditCheckBox_CheckedChanged(object sender, System.EventArgs e)
        {
            ShowEdit = EditCheckBox.Checked;
        }

        // NeuButton_Click()
        protected void NeuButton_Click(object sender, System.EventArgs e)
        {
        ...
        protected void ClearImageButton_Click(object sender, System.Web.UI.ImageClickEventArgs e)
        {
            WortraumController wrc = (WortraumController) Parent;
        ...
        protected void ZweigStrichImageButton_Click(object sender, System.Web.UI.ImageClickEventArgs e)
        {
            WortraumController wrc = (WortraumController) Parent;
        ...
        protected void ZweigLinkButton_Click(object sender, System.EventArgs e)
        {
