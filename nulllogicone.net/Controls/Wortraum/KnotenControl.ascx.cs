...
namespace OliWeb.Controls.Wortraum
{
    ...
    ///    Knoten.
    ///</summary>
    public partial class KnotenControl : System.Web.UI.UserControl
    {
...
//1			nkbz = NKBZ.Instance();
        ...
        protected void UpdateButton_Click(object sender, System.EventArgs e)
        {
            ...
            // Weiter (wenn beides ausgew�hlt wird nur das Netz genommen)
...
//1			nkbz.UpdateKnoten();
        ...
        protected void KnotenPunktImageButton_Click(object sender, System.Web.UI.ImageClickEventArgs e)
        {
            WortraumController wrc = (WortraumController) Parent;
        ...
        protected void KnotenLinkButton_Click(object sender, System.EventArgs e)
        {
...
//TODO:				// Ist hier die Leiche ???? TODO
                // in einen Baum soll man reinschauen k�nnen - ohne Markierung
