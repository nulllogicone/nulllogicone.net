...
namespace OliWeb.Controls.Wortraum
{
    ...
    ///    Baum.
    ///</summary>
    public partial class BaumControl : System.Web.UI.UserControl
    {
        protected System.Web.UI.WebControls.CheckBox ShowZweigeCheckBox;
        protected System.Web.UI.WebControls.DataGrid ZweigeDataGrid;
...
//1		NKBZ nkbz;
        ...
        private void Malen()
        {
            ...
            {
                DateiImageButton.ImageUrl = OliEngine.OliCommon.bilderOrdner + myRow.Datei;
...
//1			nkbz.UpdateBaum();
        ...
        protected void NeuZweigButton_Click(object sender, System.EventArgs e)
        {
            WortraumController wrc = (WortraumController) Parent;
            MyZelle.NewChild();
            wrc.Malen();
