<%@ Control Language="c#" AutoEventWireup="false" Codebehind="ZweigControl.ascx.cs" Inherits="OliWeb.Controls.Wortraum.ZweigControl" TargetSchema="http://schemas.microsoft.com/intellisense/ie5" enableViewState="True" %>
...
<div align="right">
	<asp:imagebutton id="ClearImageButton" runat="server" imageurl="../../images/x.gif" alternatetext="Clear"
		visible="False" width="10px" height="10px" imagealign="Middle"></asp:imagebutton>&nbsp;
	...
	<asp:imagebutton id="WeiterNetzImageButton" runat="server" imageurl="../../images/icons/Wortraum/Spiegel/WeiterNetz.gif"
		width="15px" borderwidth="0px" borderstyle="Outset" cssclass="Pfeil"></asp:imagebutton>
	...
	<asp:imagebutton id="weiterNixImageButton" runat="server" imageurl="../../images/icons/Wortraum/Spiegel/WeiterNix.gif"
		width="15px" borderwidth="0px" borderstyle="Outset" cssclass="Pfeil"></asp:imagebutton>&nbsp;
	<asp:linkbutton id="ZweigLinkButton" runat="server" font-size="Smaller" cssclass="ZweigLink">LinkButton</asp:linkbutton>&nbsp;
	<asp:imagebutton id="ZweigStrichImageButton" imageurl="../../images/icons/Wortraum/Spiegel/Zweig.gif"
		runat="server" height="26px" cssclass="Zweig"></asp:imagebutton>
