...
<%@ Page Language="c#" ValidateRequest="false" CodeBehind="AnglerInput.aspx.cs" AutoEventWireup="True" Inherits="nulllogicone.net.RDF.AnglerInput" SmartNavigation="True" %>

<%@ Register TagPrefix="uc1" TagName="AnglerPostItGrid" Src="../Controls/Koerper/ViewGrids/AnglerPostItGrid.ascx" %>
<!DOCTYPE HTML>
<html>
<head>
    <title>AnglerInput</title>
...
<body>
    <form id="Form1" method="post" runat="server">
        ...
        <h1>
            <asp:HyperLink ID="HyperLink1" runat="server" NavigateUrl="default.aspx">IO.</asp:HyperLink>Angler 
				Input</h1>
        <p>
            URL<br>
            <asp:TextBox ID="UrlTextBox" runat="server" Width="528px">https://nulllogicone.net/Angler/be279cca-b934-45e6-85fd-96b1a6b1e6ed.rdf</asp:TextBox>
            ...
            <table id="Table1" cellspacing="1" cellpadding="1" width="100%" border="0">
                <tr>
                    <td style="width: 259px">
                        ...
                        <asp:CheckBox ID="MatchCheckBox" runat="server" Text="show matching Messages"></asp:CheckBox></td>
                    <td valign="top">
        ...
        <h2>DataGrid View</h2>
        <p>
            <asp:DataGrid ID="AnglerDataGrid" runat="server" BorderColor="#E7E7FF" BorderStyle="None" BorderWidth="1px"
                BackColor="White" CellPadding="3" GridLines="Horizontal" Width="100%">
                ...
                <Columns>
                    ...
                    <asp:TemplateColumn HeaderText="AnglerGuid">
                        <ItemTemplate>
                            <a href='<%# "https://nulllogicone.net/Angler/?" + DataBinder.Eval(Container, "DataItem.AnglerGuid") %>'>
                                <%# DataBinder.Eval(Container, "DataItem.AnglerGuid") %>
                            </a>
                        </ItemTemplate>
                    </asp:TemplateColumn>
                </Columns>
        ...
        <p>
            <asp:DataGrid ID="LöcherDataGrid" runat="server" BorderColor="#999999" BorderStyle="None" BorderWidth="1px"
                BackColor="White" CellPadding="3" GridLines="Vertical" Width="100%">
