...
namespace nulllogicone.net.Controls.AjaxWortraum
{
    ...
    ///</summary>
    public partial class AjaxWortraumControlFlip : System.Web.UI.UserControl
    {
        // Member
        // ------
        private const int INDENT = 20;
        private readonly string imgroot = OliEngine.OliCommon.RootPath;

        private readonly string Nimg = "<img src=\"" + OliEngine.OliCommon.RootPath +
                                       "images/icons/Wortraum/N16.gif\" style=\"border:0px; \" />&nbsp;";

        private readonly string Kimg = "<img src=\"" + OliEngine.OliCommon.RootPath +
                                       "images/icons/Wortraum/K16.gif\" style=\"border:0px;\" />&nbsp;";

        private readonly string Bimg = "<img src=\"" + OliEngine.OliCommon.RootPath +
                                       "images/icons/Wortraum/B16.gif\" style=\"border:0px;\" />&nbsp;";

        private readonly string Zimg = "<img src=\"" + OliEngine.OliCommon.RootPath +
                                       "images/icons/Wortraum/Spiegel/Z16.gif\" style=\"border:0px;\" />&nbsp;";

        private readonly string wNimg = "<img src=\"" + OliEngine.OliCommon.RootPath +
                                        "images/icons/Wortraum/Spiegel/wN16.gif\" style=\"vertical-align:middle;border:0px;\" />&nbsp;";

        private readonly string wBimg = "<img src=\"" + OliEngine.OliCommon.RootPath +
                                        "images/icons/Wortraum/Spiegel/wB16.gif\" style=\"vertical-align:middle;border:0px;\" />&nbsp;";
        ...
        {
            Ajax.Utility.RegisterTypeForAjax(typeof (AjaxWortraumControlFlip));
            if (!Markierbar)
            {
        ...
        /// <summary>
        ///     f�llt die Wortraum Wurzel in das Label
        /// </summary>
        /// <param name = "e"></param>
        protected override void OnPreRender(EventArgs e)
        {
            base.OnPreRender(e);
            WortraumLabel.Text = makeNetz(OliEngine.OliMiddleTier.OLIx.Netz.GetRoot().NetzRow.NetzGuid.ToString(), 0,
                                          false);
            if (Markierer != null)
            {
                ...
                if (Markierer is OliEngine.OliMiddleTier.OLIs.Angler)
                {
                    WortraumPanel.Attributes.Remove("style");
                }
            }
        ...
        {
            get { return (IMarkierer) System.Web.HttpContext.Current.Session["markierer"]; }
            set { System.Web.HttpContext.Current.Session["markierer"] = value; }
        }
        ...
        public bool Markierbar
        {
            get
            {
                ...
                if (System.Web.HttpContext.Current.Session["markierbar"] != null)
                {
                    return bool.Parse(System.Web.HttpContext.Current.Session["markierbar"].ToString());
                }
                return false;
            }
            set { System.Web.HttpContext.Current.Session["markierbar"] = value; }
        }
        ...
        public bool ShowVgb
        {
            get
            {
                if (System.Web.HttpContext.Current.Session["showVgb"] == null)
                {
                    return false;
                }
                return bool.Parse(System.Web.HttpContext.Current.Session["showVgb"].ToString());
            }
            set { System.Web.HttpContext.Current.Session["showVgb"] = value; }
        }
        ...
        public bool Werbefrei
        {
            get
            {
                if (System.Web.HttpContext.Current.Session["werbefrei"] == null)
                {
                    return false;
                }
                return bool.Parse(System.Web.HttpContext.Current.Session["werbefrei"].ToString());
            }
            set { System.Web.HttpContext.Current.Session["werbefrei"] = value; }
        }
        ...
        private string makeNetz(string nguidstr, int ebene, bool onlymarked)
        {
            ...
            OliEngine.OliMiddleTier.OLIx.Knoten kn = new OliEngine.OliMiddleTier.OLIx.Knoten(n.NetzRow);

            // Netz DIV
            sb.Append("<div style=\"padding-right:" + ebene*INDENT + "px;text-align:right;\"");
            ...
            {
                sb.Append("<img style=\"float:left; width:50px;\" src=\"" + OliEngine.OliCommon.bilderOrdner +
                          n.NetzRow.Datei + "\"/>");
            }
            ...
            foreach (KnotenDataSet.KnotenRow kr in kn.Knoten)
            {
                ...
                if (Markierer != null)
                {
                    if (Markierer is OliEngine.OliMiddleTier.OLIs.Code)
                    {
                        OliEngine.OliMiddleTier.OLIs.Code c = (OliEngine.OliMiddleTier.OLIs.Code) Markierer;
                        og = c.IsInString(kr);
                    }
                    if (Markierer is OliEngine.OliMiddleTier.OLIs.Angler)
                    {
                        OliEngine.OliMiddleTier.OLIs.Angler a = (OliEngine.OliMiddleTier.OLIs.Angler) Markierer;
                        og = a.IsInString(kr);
                    }
                }
                ...
                if (onlymarked && og.Length > 0 || !onlymarked)
                {
                    ...
                    if (og.Length > 0)
                    {
                        ...
                        if (mwk.Length > 0)
                        {
                            sb.Append("<div style=\"padding-right:" + (ebene + 1)*INDENT +
                                      "px;display:block;text-align:right;\"");
                        ...
                        {
                            sb.Append("<div style=\"padding-right:" + (ebene + 1)*INDENT +
                                      "px;display:none;text-align:right;\"");
                            sb.Append("ID=\"" + kr.KnotenGuid + "\">");
                        }
                    }
                    else
        ...
        private string makeKnoten(KnotenDataSet.KnotenRow kr, int ebene, bool onlymarked)
        {
            ...
            // Das Knoten DIV
            // --------------
            sb.Append("<div style=\"white-space:nowrap;padding-right:" + ebene*INDENT + "px;text-align:right;\" ");
        ...
        private string makeBaum(KnotenDataSet.KnotenRow lastKnoten, string bguidstr, int ebene, bool onlymarked)
        {
            ...
            OliEngine.OliMiddleTier.OLIx.Zweig zw = new OliEngine.OliMiddleTier.OLIx.Zweig(b.BaumRow);

            // Baum
            sb.Append("<div style=\"padding-right:" + ebene*INDENT + "px;\"");
            ...
            foreach (ZweigDataSet.ZweigRow zr in zw.Zweig)
            {
                ...
                if (onlymarked && og.Length > 0 || !onlymarked)
                {
                    ...
                    if (og.Length > 0)
                    {
                        ...
                        {
                            sb.Append("<div style=\"padding-right:" + (ebene + 1)*INDENT + "px;display:none;\"");
                            sb.Append("ID=\"" + lastKnoten.KnotenGuid + zr.ZweigGuid + "\">");
                        }
                    }
                    else
        ...
        {
            OliEngine.OliMiddleTier.OLIx.Knoten k = new OliEngine.OliMiddleTier.OLIx.Knoten(new Guid(kguidstr));
        ...
        {
            OliEngine.OliMiddleTier.OLIx.Knoten k = new OliEngine.OliMiddleTier.OLIx.Knoten(new Guid(lastknoten));
            OliEngine.OliMiddleTier.OLIx.Zweig z = new OliEngine.OliMiddleTier.OLIx.Zweig(new Guid(zguidstr));
        ...
        {
            OliEngine.OliMiddleTier.OLIx.Knoten k = new OliEngine.OliMiddleTier.OLIx.Knoten(new Guid(kguid));
            if (Markierbar && Markierer != null)
            {
                if (Markierer is OliEngine.OliMiddleTier.OLIs.Code)
                {
        ...
        {
            OliEngine.OliMiddleTier.OLIx.Knoten k = new OliEngine.OliMiddleTier.OLIx.Knoten(new Guid(kguid));
            OliEngine.OliMiddleTier.OLIx.Zweig z = new OliEngine.OliMiddleTier.OLIx.Zweig(new Guid(zguid));
