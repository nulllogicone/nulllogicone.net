<%@ Control Language="c#" AutoEventWireup="false" Codebehind="NetzControl.ascx.cs" Inherits="OliWeb.Controls.Wortraum.NetzControl" TargetSchema="http://schemas.microsoft.com/intellisense/ie5" enableViewState="True" %>
...
<div align="right">
	...
	<asp:checkbox id="EditCheckBox" runat="server" visible="False" autopostback="True"></asp:checkbox>
</div>
