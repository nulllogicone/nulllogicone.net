<%@ Control Language="c#" AutoEventWireup="True" Codebehind="BaumControl.ascx.cs" Inherits="OliWeb.Controls.Wortraum.BaumControl" TargetSchema="http://schemas.microsoft.com/intellisense/ie5" enableViewState="True" %>
<div >
<asp:imagebutton id="DateiImageButton" runat="server" width="80px" imagealign="Right" cssclass="Werbung"></asp:imagebutton>
<asp:checkbox id="EditCheckBox" runat="server" autopostback="True" designtimedragdrop="5" visible="False" oncheckedchanged="EditCheckBox_CheckedChanged"></asp:checkbox>
