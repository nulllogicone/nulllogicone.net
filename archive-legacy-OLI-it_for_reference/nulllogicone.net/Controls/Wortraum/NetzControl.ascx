<%@ Control Language="c#" AutoEventWireup="True" Codebehind="NetzControl.ascx.cs" Inherits="OliWeb.Controls.Wortraum.NetzControl" TargetSchema="http://schemas.microsoft.com/intellisense/ie5" enableViewState="True" %>
