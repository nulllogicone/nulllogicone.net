<%@ Control Language="c#" AutoEventWireup="True" Codebehind="BuntePunkte.ascx.cs" Inherits="OliWeb.Controls.Wortraum.BuntePunkte" TargetSchema="http://schemas.microsoft.com/intellisense/ie5" %>
