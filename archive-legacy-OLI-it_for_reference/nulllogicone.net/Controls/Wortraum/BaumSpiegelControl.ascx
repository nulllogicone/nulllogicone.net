<%@ Control Language="c#" AutoEventWireup="false" Codebehind="BaumControl.ascx.cs" Inherits="OliWeb.Controls.Wortraum.BaumControl" TargetSchema="http://schemas.microsoft.com/intellisense/ie5" enableViewState="True" %>
