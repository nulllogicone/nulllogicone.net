    ...
    public abstract class OliCommon
    {
        ...
        public static string EmailSignature
        {
            get
            {
                ...
                sb.Append("\n\n-- \nDiese Nachricht wurde �ber www.oli-it.com versendet.");
        ...
        /// <summary>
        ///     DbServer Eine Enumerations-Eigenschaft, �ber die man
