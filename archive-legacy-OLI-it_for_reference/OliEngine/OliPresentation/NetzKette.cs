...
{
	/// <summary>
	/// Zusammendfassende Beschreibung f�r NetzKette.
	/// 
	/// Die Klasse verh�lt sich wie ein Stack.
	/// Es k�nnen NetzKettenGlieder (eingebettete Klasse)
	/// eingef�gt werden (ohne doppelte NetzID)
	/// 
	/// </summary>
	public class NetzKette
	{
		...
		// KettenGlieder gibt ein Array von NetzKettenGliedern zur�ck
		...
		// neues KettenGlied dem Array hinzuf�gen
		...
		// Gibt das zuletzt eingef�gte KettenGlied zur�ck
