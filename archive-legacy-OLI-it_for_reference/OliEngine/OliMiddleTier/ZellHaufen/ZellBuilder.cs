...
namespace OliEngine.OliMiddleTier.ZellHaufen
{
    ...
    public class ZellBuilder
    {
        ...
        ///     Wenn er zugewiesen wird, wird die Wurzel mit den daranh�ngenden Markierungen gef�llt.
        /// </summary>
        ...
        /// <summary>
        ///     wenn es nicht von hier nicht weitergeht werden alle Knoten bzw. Zweige ge�ffnet
