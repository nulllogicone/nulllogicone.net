...
namespace OliEngine.OliMiddleTier.Markierer
{
    ...
    public abstract class Markierer
    {
        ...
        public abstract bool IsInStrings(ref KnotenZelle kz); // Obacht: Parameter wird ge�ndert!

        // IsInStrings(ZweigZelle)
        public abstract bool IsInStrings(ref ZweigZelle zz); // Obacht: Parameter wird ge�ndert!
