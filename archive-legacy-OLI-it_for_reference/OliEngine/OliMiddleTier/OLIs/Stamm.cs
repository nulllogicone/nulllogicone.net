...
namespace OliEngine.OliMiddleTier.OLIs
{
    ...
    public class Stamm
    {
        ...
        // ein Verweis auf das aktuell ausgew�hlte Objekt
...
//		FristAbgelaufenDataSet.FristAbgelaufenDataTableDataTable fristAbgelaufen;
        ...
        // Werbefrei                   ******** 
        // TODO: diese Eigenschaft geh�rt zu der Stamm-Eigenschaften Tabelle
...
//		private Stamm.SichtbaresGrid sichtbareGrid = Stamm.SichtbaresGrid.None;
        ...
        /// <summary>
        ///     Konstruktor f�r Stamm(mit user)
        ///     <param name = "user">Ein Stamm h�ngt immer an einem user-Objekt</param>
...
//					user.Nachricht = "Sie k�nnen frankieren und eine Frist setzen";
                }
