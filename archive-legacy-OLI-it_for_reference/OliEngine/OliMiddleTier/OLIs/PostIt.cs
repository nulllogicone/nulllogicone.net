...
namespace OliEngine.OliMiddleTier.OLIs
{
    ...
    public class PostIt
    {
        ...
        //
        // In der Update Methode wird gepr�ft, ob es ein neues
        // PostIt ist und dann mit dem Stamm �ber einen neuen Eintrag 
        // in die Wurzeltabelle verkn�pft und ein leerer Code erstellt
        ...
        // Daf�r ist die Dokumentation allerdings etwas d�rftig (von 2004) also kein Unit-Test!
        ...
        ///     auch nachtr�glich angewurzelt haben)
        /// </summary>
        ...
        ///     mit StammZust=2.
        ///     <strong>Au�erdem wird 1 KooK bezahlt</strong> und die Frist auf Standard-Offset
        ///     gesetzt
        /// </summary>
        ...
        public void Anwurzeln(EingeloggterStamm eingeloggterStamm)
        {
            ...
            stamm.OliUser.Nachricht = "Sie wurden angewurzelt und 1 KooK �bertragen";
        }

        /// <summary>
        ///     Die verbindung dieser Nachricht zum aktuellen Stamm wird abgebrochen = gel�scht!
        ///     Es werden keine KooK (zur�ck) �bertragen sondern einfach die n:m Zeile in der
        ///     Wurzel Tabelle gel�scht
        /// </summary>
        /// <param name = "eingeloggterStamm"></param>
            ...
            if (UrheberStamm.StammRow.StammGuid != eingeloggterStamm.StammRow.StammGuid)
            {
                ...
                else
                {
                    stamm.OliUser.Nachricht =
                        "Wenn sie einen negativen Betrag bezahlt haben, k�nnen Sie sich nicht abwurzeln";
                }
            }
            else
            {
        ...
        ///     Wenn es sich um ein neues PostIt handelt, wird es �ber einen neuen
        ///     Eintrag in der Wurzeltabelle mit dem Stamm verkn�pft und ein
        ...
        public int UpdatePostIt()
        {
            ...
            // an den Stamm angewurzelt und erh�lt einen neuen Code
            ...
            {
                throw new Exception("ein nicht eingeloggter versucht PostIt zu �ndern");
            }
        }
        ...
        public string MakePostItRDF()
        {
            ...
            // -- PostItAngler
            xw.WriteComment("PostItAngler - die Empf�nger");
            xw.WriteComment("============================");
