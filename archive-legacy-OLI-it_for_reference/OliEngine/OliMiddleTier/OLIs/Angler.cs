...
//		bool showWortraum;
        ...
        ///     AnglerGuid und implizit den dazugeh�renden Stamm.
        ///     Normalerweise sollte ein Angler nur �ber das bestehende OliUser.Stamm
        ...
        public AnglerDataSet.L�cherDataTable MyL�cher
        {
            get
            {
                AnglerDataSet.L�cherDataTable ldt;
                ldt = angler.L�cher;
                return ldt;
            }
        }
...
//		/// <summary>
//		/// ShowWortraum ************ sollte gel�scht werden ***************
//		/// </summary>
...
//			return angler.UpdateAngler();
        ...
        {
            foreach (AnglerDataSet.L�cherRow lr in MyL�cher)
            {
        ...
        public void Markiere(KnotenDataSet.KnotenRow kr)
        {
            ...
            {
                AnglerDataSet.L�cherRow lr = angler.L�cher.NewL�cherRow();
