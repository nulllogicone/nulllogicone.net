...
// nicht im UI sondern tief verborgen
    public abstract class OliUtil
    {
        ...
        // IsNumeric(string)
        /// <summary>
        ///     pr�ft ob die �bergebene Zeichenfolge eine int-Zahl darstellt
        /// </summary>
        /// <param name="value"> Zeichenfolge, die auf Zahl gepr�ft werden soll </param>
        /// <returns> Gibt true zur�ck wenn es sich um eine Zahl handelt </returns>
        ...
        /// <returns> </returns>
        [Obsolete(
            "diese 'hardcoded' html Methode sollte �ber design mit css-Weltkugel-Design gel�st werden. Dann hat ein Link ein Ziel und eine Darstellung"
            )]
