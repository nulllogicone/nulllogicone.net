...
namespace OliEngine.OliDataAccess
{
    ...
    /// 
    ///     Man kann auch int f�r StammID �bergeben oder
    ///     eine Zeichenfolge. (es l�sst sich nach genauer
    ///     �bereinstimmung oder 'enthaltensein' suchen)
    /// </summary>
