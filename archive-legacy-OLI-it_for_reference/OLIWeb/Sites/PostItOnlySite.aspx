<%@ Page Language="c#" CodeBehind="PostItOnlySite.aspx.cs" AutoEventWireup="True" Inherits="OliWeb.Sites.PostItOnlySite"
    EnableViewState="False" MasterPageFile="~/SiteOnly.Master" Description="Eine Frage, Nachricht, Angebot," %>
