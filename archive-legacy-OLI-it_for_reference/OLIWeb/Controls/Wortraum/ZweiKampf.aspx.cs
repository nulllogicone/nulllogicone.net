...
namespace OliWeb.Controls.Wortraum
{
    ...
    {
        protected DropDownList CodeDropDownList;
...
//				CodeWortraumController.ZellBuilder = codeZellBuilder;	
        ...
        protected void PostItDropDownList_SelectedIndexChanged(object sender, EventArgs e)
        {
            Guid pguid = new Guid(PostItDropDownList.SelectedItem.Value);
            PostIt p = new PostIt(pguid);
        ...
        protected void CodeListBox_SelectedIndexChanged(object sender, EventArgs e)
        {
        ...
        protected void StammAnglerDropDownList_SelectedIndexChanged(object sender, EventArgs e)
        {
            Guid sguid = new Guid(StammAnglerDropDownList.SelectedItem.Value);

            if (sguid != Guid.Empty)
            {
                Stamm s = new Stamm(sguid);

                AnglerList al = new AnglerList(s.StammRow);
                AnglerListBox.DataSource = al.Angler;
        ...
        protected void AnglerListBox_SelectedIndexChanged(object sender, EventArgs e)
        {
        ...
        // FischenButton_Click
        protected void FischenButton_Click(object sender, EventArgs e)
        {
            // cid-aid festlegen
            Guid cguid = new Guid(CodeListBox.SelectedItem.Value);
            Guid aguid = new Guid(AnglerListBox.SelectedItem.Value);
        ...
        // CodeXButton_Click()
        protected void CodeXButton_Click(object sender, EventArgs e)
        {
            Guid cguid = new Guid(CodeListBox.SelectedItem.Value);
        ...
        // AnglerXButton_Click()
        protected void AnglerXButton_Click(object sender, EventArgs e)
        {
            Guid aguid = new Guid(AnglerListBox.SelectedItem.Value);
            Fischer f = new Fischer();
        ...
        protected void AnzAnglerLinkButton_Click(object sender, EventArgs e)
        {
        }

        protected void AnzCodeLinkButton_Click(object sender, EventArgs e)
        {
        }
    }
}
