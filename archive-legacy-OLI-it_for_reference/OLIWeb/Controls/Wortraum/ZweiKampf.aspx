            ...
            <table id="ZweiKampfKopfTable" cellspacing="1" cellpadding="1" width="100%" border="0">
                <tr>
                    ...
                    <td valign="top" align="center" width="33%">
                        ...
                        <asp:linkbutton id="AnzCodeLinkButton" runat="server" onclick="AnzCodeLinkButton_Click">Anzahl Treffer</asp:linkbutton><br />
                        <asp:button id="CodeXButton" runat="server" text="x" tooltip="Vergleicht den Code gegen alle Filterprofile"
                                    enabled="False" onclick="CodeXButton_Click"></asp:button>&nbsp;-
                        <asp:button id="AnglerXButton" runat="server" text="x" tooltip="Vergleicht das Filterprofil gegen alle Markierungen"
                ...
                <tr>
                    ...
                    <td align="right">
                        <asp:dropdownlist id="StammAnglerDropDownList" runat="server" autopostback="True" width="400px" datavaluefield="StammGuid"
                                          datatextfield="Stamm" cssclass="Stamm" onselectedindexchanged="StammAnglerDropDownList_SelectedIndexChanged"></asp:dropdownlist></td>
                </tr>
                <tr>
                    <td>
