...
{
    ///<summary>
    ///    wird als oberstes Element auf den Seiten eingebunden. Es enth�lt
    ///    das <see cref="Floor.LogoControl" />, daneben Platz f�r <b>Nachrichten</b> und das <see cref="Floor.EinAusLoggen" />-Control.
    ///    Ausserdem enth�lt es die <see cref="CommandBar" /> als vertikale Men�leiste.
    ///</summary>
