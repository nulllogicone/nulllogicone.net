...
{
    /// <summary>
    ///     f�r eine gefundene St�mmen mit Bild und Trefferanzahl im Titel
    /// </summary>
    public partial class StammListsControl : MasterControl
    {
        /// <summary>
        ///     die Ausgabetabelle f�r Stammbild und Name
        /// </summary>
        /// <remarks>
        ///     <h2>Zu den anderen DataGrids noch ein summary hinzuf�gen!</h2>
        /// </remarks>
