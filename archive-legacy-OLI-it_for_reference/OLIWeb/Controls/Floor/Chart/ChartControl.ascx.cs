...
{
    ///<summary>
    ///    <b>Container-</b> Control f�r die einzelnen (Stamm, PostIt, TopLab)-ChartControls.
    ///    Hier werden die Daten an die Controls �bergeben, da sie mehrfach verwendet
    ///    werden k�nnen (f�r TOP und FLOP)
    ///</summary>
    ///<remarks>
    ...
    public partial class ChartControl : MasterControl
    {
        ...
        /// <summary>
        ///     Die TOP und FLOP Daten werden an die passenden Controls �bergeben.
        /// </summary>
        /// <param name="e"> </param>
