...
{
    ///<summary>
    ///    Ein Control f�r aktuelle Schlagzeilen von Telepolis.
    ///</summary>
    ///<remarks>
    ///    Hier ist es schon �fters zu Fehlern gekommen, nachdem das
    ///    rss-Format ge�ndert wurde oder als der Service nicht erreichbar war.
    ///</remarks>
    public partial class Telepolis : UserControl
    {
        /// <summary>
        ///     gew�nschte Anzahl der Schlagzeilen
        /// </summary>
        ...
        ///     Dann werden die Nachrichten aus dem Cache zuf�llig auf die gew�nschte Anzahl gek�rzt und im Repeater dargestellt.
        /// </summary>
        ...
        protected void Page_Load(object sender, EventArgs e)
        {
            try
            {
                ...
                // Zuf�llig Artikel wegwerfen bis nur noch
                // HEADCOUNT �brig sind (wird sonst zu lang)
            ...
            {
                Label1.Text =
                    "<oli-it><fehler><span title=\"068fe65c-2564-426e-bf40-5045c1e323de\">kein Newsfeed von Telepolis verf�gbar</span></fehler></oli-it>";
            }
        }
