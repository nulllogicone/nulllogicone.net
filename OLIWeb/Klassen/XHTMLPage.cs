 ...
 * Mise � jour et adaptation : S�bastien FERRAND (http://www.vbmaf.net)
 * Description   : Transforme le code HTML g�n�r� par asp.net pour le rendre
 ...
 * Mise � jour des m�thodes ConvertToLowerCase(), SingleTagToLowerCase() et 
 * PropertiesToLowerCase() pour la prise en charge des tags avec ou sans propri�t�
 * et les propri�t�s multiples pour un tag
 * --
 * Add support for tags with/without properties and multiproperties tags.
 * ------------------------------------------------------------------------------
 * Licence      : Cette classe est livr�e telle quelle. Le ou les auteurs ne sont
 *              en rien responsable de l'utilisation qui en sera fait.
 *              Vous �tes libre de distribuer ou d'utiliser cette classe dans 
 *              vos projets � condition que cet ent�te reste pr�sente.
 */
...
namespace OliWeb 
{
	...
	public class XHTMLPage : System.Web.UI.Page 
	{
		...
		/// <summary>
		/// F�gt vor das Ende /form /body /html noch eine OLI-it Fu�zeile ein
		/// </summary>
		...
		private void ConvertToLowerCase() 
		{
			...
			/// Author : S�bastien FERRAND (mailto:sebastien.ferrand@vbmaf.net)
