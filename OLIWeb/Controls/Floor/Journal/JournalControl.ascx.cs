...
namespace OliWeb.Controls.Floor.Journal
{
    ...
    ///<summary>
    ///    Das Control f�r die neuesten <a href="SAPCT.htm">[SAPCT]</a> - Eintr�ge in die Datenbank.
    ///</summary>
    public partial class JournalControl : MasterControl
    {
        ...
        /// <summary>
        ///     Es soll nicht m�glich sein, alle Datens�tze aus einer
        ...
        ///     TODO: K�nnte eigentlich auch in den Application Cache!
        /// </summary>
        ...
        ///     wenn n�tig auf zwischen 1 und MAXZEILEN korrigiert.
        /// </summary>
        ...
        /// <summary>
        ///     Beim ersten Aufruf diese Controls wird die interne journal-Tabelle gef�llt
