...
{
    /// <summary>
    ///     dieses Control hat zwei Zust�nde: Wenn man eingeloggt ist, zeigt es den
    ///     Stamm (draufklicken l�dt die Daten neu) und Button zum ausloggen - sonst
    ///     zeigt es zwei Textboxen f�r Name und Kennwort zum einloggen.
    /// </summary>
    public partial class EinAusLoggen : MasterControl
    {
        ...
        /// <summary>
        ///     <b>javasripct</b> f�r die Stamm- und Kennwort-Textboxen stellt den Fokus f�r das Enter-Klicken auf den
        ///     <see cref="ShowStammButton" /> ein.
        /// </summary>
        /// <remarks>
        ///     Die ID der Steuerelemente h�ngen davon ab wo dieses Control platziert ist. Am einfachsten �ffnet man
        ...
        /// <summary>
        ///     abh�ngig ob jemand eingeloggt ist, wird entweder das eine oder
        ...
        /// <summary>
        ///     <b>POST</b> mit Name und Kennwort zum Einloggen. Schl�gt der Versuch
        ...
        {
            // ein evtl gesetztes Cookie l�uft sofort ab!
        ...
        private void showStamm()
        {
            ...
            if (MerkenCheckBox.Checked)
            {
                ...
                c.Value = "Cookie f�r automatisch Anmelden bei www.oli-it.com";
