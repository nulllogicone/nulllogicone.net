...
<%@ Control Language="c#" AutoEventWireup="false" Codebehind="ZweigControl.ascx.cs" Inherits="OliWeb.Controls.Wortraum.ZweigControl"   enableViewState="True"%>
<div>
...
<asp:imagebutton id="ZweigStrichImageButton" runat="server" imageurl="../../images/icons/Wortraum/Zweig.gif"
	height="26px" cssclass="Zweig"></asp:imagebutton>&nbsp;
<asp:linkbutton id="ZweigLinkButton" runat="server" font-size="Smaller" cssclass="ZweigLink"></asp:linkbutton>&nbsp;
