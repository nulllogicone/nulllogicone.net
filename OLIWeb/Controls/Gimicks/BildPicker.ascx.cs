...
{
    /// <summary>
    ///     gekachelte Ansicht der Bilder aus dem dem Stamm-Unterordner mit M�glichkeit
    ///     f�r Upload und Auswahl.
    /// </summary>
    public partial class BildPicker : MasterControl
    {
        /// <summary>
        ///     Wenn ein Bild ausgew�hlt wurde, kann das Ereignis behandelt werden.
        /// </summary>
        public delegate void BildSelectEventHandler(BildPicker sender, BildSelectEventArgs e);

        /// <summary>
        ///     Gr��enbeschr�nkung f�r Bilddateien, die auf den Server hochgeladen werden sollen
        /// </summary>
        ...
        /// <summary>
        ///     st��t den Bildupload an
        /// </summary>
        protected HtmlInputButton UploadButton;

        /// <summary>
        ///     Das Ereignis wird gefeuert wenn ein Bild ausgew�hlt wurde.
        /// </summary>
        public event BildSelectEventHandler BildSelect;

        /// <summary>
        ///     beim ersten Laden des Controls wird die ListBox gef�llt
        /// </summary>
        ...
        /// <summary>
        ///     nachdem ein Bild auf der lokalen Platte ausgew�hlt wurde, muss man auf den
    ...
    /// <summary>
    ///     Wenn ein Bild ausgew�hlt wurde, wird ein Ereignis ausgel�st und der Dateiname
    ///     als Argument �bergeben.
    /// </summary>
    public class BildSelectEventArgs : EventArgs
    {
        /// <summary>
        ///     der Name des ausgew�hlten Bildes
        /// </summary>
