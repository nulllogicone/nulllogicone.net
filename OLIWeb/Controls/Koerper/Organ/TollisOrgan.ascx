...
<%@ Control Language="c#" AutoEventWireup="True" Codebehind="TollisOrgan.ascx.cs" Inherits="OliWeb.Controls.Koerper.Organ.TollisOrgan"  %>
<p>Bewertung (0-100)
	...
	<asp:button id="AbgebenButton" runat="server" cssclass="Button" text="abgeben" onclick="AbgebenButton_Click"></asp:button><br />
</p>
