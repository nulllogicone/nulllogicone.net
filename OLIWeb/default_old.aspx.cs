...
namespace OliWeb
{
    ...
    ///     Wenn ein Querystring �bergeben wird, wird dieser ausgewertet und ggf.
    ///     weitergeleitet.
    ///     Die Seite enth�lt das <see cref="Controls.Floor.AnonymMenu" />- und <see cref="Controls.Floor.AnonymIntro" />-Control
    /// </summary>
    public partial class _default_old : BasePage
    {
        ...
        {
            // Mit �bergabeparametern entsprechende Seite Laden
        ...
        /// <summary>
        ///     falls beim Aufruf von oli-it ein Querystring �bergeben wird,
